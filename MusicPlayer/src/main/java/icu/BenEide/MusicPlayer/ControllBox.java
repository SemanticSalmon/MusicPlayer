...
public class ControllBox {
    ...
    private static final Image defaultCover = new Image(MusicPlayer.class.getResourceAsStream("images/defaultCover.png"));
    private static final ConfigurationFile CONFIGURATION_FILE = ConfigurationFile.getInstance();
    ...
    public void initialize() {
        ...
        // Default to lyrics view on startup
        radioButtonLyrics.setSelected(true);
        listViewSong.setVisible(false);

        // Sync progress and volume bars with sliders
        ...
        volumeSlider.setValue(CONFIGURATION_FILE.getVolume());
        ...
        volumeSlider.valueProperty().addListener((obs, oldVal, newVal) -> {
            ...
            if (volumeSlider.isValueChanging()) {
                ...
                CONFIGURATION_FILE.setVolume(newVal.doubleValue());
            }
        });
    ...
    protected void onListViewSongDragDropped(DragEvent e) {
        ...
        listViewSong.getItems().addAll(dragboard.getFiles().stream()
    ...
    private void play(Song s) {
        ...
        // Populate lyrics view
        var rawPath = s.getUri().getRawPath();
        var lyrics = LyricTokenizer.parse(rawPath.substring(0, rawPath.lastIndexOf('.')) + ".lrc");
